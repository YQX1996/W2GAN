...
if __name__ == '__main__':
    ...
    # parser.add_argument('--policy', default='color,translation,cutout')
    ...
    parser.add_argument('--resume_iter', type=int, default=60000, help='Iterations to resume training/testing')
    ...
    parser.add_argument('--beta1', type=float, default=0.00, help='Decay rate for 1st moment of Adam')
    ...
    # misc
    parser.add_argument('--mode', default='eval', choices=['train', 'sample', 'eval', 'align'],
    ...
    parser.add_argument('--train_img_dir', type=str,
                        default='data/afhq/train_10%',
                        help='Directory containing training images')
    parser.add_argument('--val_img_dir', type=str, default='data/afhq/val',
                        help='Directory containing validation images')
    parser.add_argument('--sample_dir', type=str,
                        default='expr-afhq-100%/samples',
                        help='Directory for saving generated images')
    parser.add_argument('--checkpoint_dir', type=str,
                        default='expr-AFHQ/expr-high-fusion-noLatentTPA/checkpoints',
                        help='Directory for saving network checkpoints')

    # directory for calculating metrics
    parser.add_argument('--eval_dir', type=str,
                        default='expr-test/eval',
                        help='Directory for saving metrics, i.e., FID and LPIPS')

    # directory for testing
    parser.add_argument('--result_dir', type=str,
                        default='expr-afhq-100%/results',
                        help='Directory for saving generated images and videos')
    parser.add_argument('--src_dir', type=str, default='data/afhq/failure-b/src',
                        help='Directory containing input source images')
    parser.add_argument('--ref_dir', type=str, default='data/afhq/failure-b/ref',
